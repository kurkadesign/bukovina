...
export const TYPES=[
  ...
  ['head-table','Svadobný stôl','fa_rings_wedding',260,90,8,{icon:false,text:false,shape:'rounded'}],
  ...
  ['decoration','Dekorácia','fa_balloon',70,70,0,{icon:true,text:false,shape:'none'}],
  ['plant','Rastlina','fa_flower_tulip',70,70,0,{icon:true,text:false,shape:'none'}],
...
export function initialState(){const t1=uid(),t2=uid(),t3=uid(),g1=uid(),g2=uid(),g3=uid(),g4=uid();return{schemaVersion:1,projectId:uid(),wedding:{date:'2026-09-12',contactName:'Jana',phone:'',email:'',note:''},settings:{zoom:0.72,panX:60,panY:35},items:[
  ...
  {id:g1,firstName:'Zuzana',lastName:'Nováková',personType:'adult',childAge:'',tableId:t2,seatNumber:1,menu:'Klasické',allergies:['Arašidy'],note:'',companion:'Peter Novák',group:'Novákovci',rsvp:'yes',color:'#e99499'},
  {id:g2,firstName:'Peter',lastName:'Novák',personType:'adult',childAge:'',tableId:t2,seatNumber:2,menu:'Klasické',allergies:[],note:'',companion:'Zuzana Nováková',group:'Novákovci',rsvp:'yes',color:'#91addc'},
