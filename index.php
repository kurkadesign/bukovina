...
$assetFiles=['style.css','panel.css','readonly.css','css/fontawesome.css','css/sharp-light.css','js/bootstrap.js','js/app.js','js/state.js','js/vendor/html2canvas.min.js','js/vendor/jspdf.umd.min.js'];
