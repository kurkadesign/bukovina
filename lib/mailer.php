...
function send_from_template(string $key,string $to,array $project,string $buttonUrl='',array $extra=[]):array{require_once __DIR__.'/email_templates.php';$t=get_rendered_email_template($key,$project,$extra);return send_app_mail($to,$t['subject'],email_layout($t['title'],$t['body'],$t['buttonLabel'],$buttonUrl,$t['signature']));}
