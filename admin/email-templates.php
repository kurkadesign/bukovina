...
$sample=['name'=>'Firemný event','client'=>['name'=>'Ján Novák','email'=>'jan@mail.sk'],'eventDate'=>'2026-09-12','state'=>['guests'=>array_fill(0,86,[]),'items'=>array_fill(0,14,[])],'meta'=>['templateOwner'=>$userEmail]];
...
$previewHtml=email_layout($preview['title'],$preview['body'],$preview['buttonLabel'],'#',$preview['signature']);
...
<script>
const sample={project_name:'Firemný event',client_name:'Ján Novák',client_email:'jan@mail.sk',wedding_date:'12.09.2026',guest_count:'86',item_count:'14',review_note:'Prosíme upraviť sedenie pri stole číslo 4.'};
