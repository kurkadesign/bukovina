...
$sample=['name'=>'Firemný event','client'=>['name'=>'Ján Novák','email'=>'jan@example.sk'],'eventDate'=>'2026-09-12','state'=>['guests'=>array_fill(0,86,[]),'items'=>array_fill(0,14,[])],'meta'=>['templateOwner'=>$userEmail]];
