...
$users=normalize_admin_users(read_json(USER_FILE));$current=(string)$_SESSION['admin'];$currentIndex=admin_user_index($users,$current);$isManager=admin_is_manager();$mustChange=!empty($users[$currentIndex]['mustChangePassword']);$message='';$error='';
