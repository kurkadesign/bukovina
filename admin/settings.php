...
<?php if($isManager):?><section class="card backup-card"><h2>Záloha systému</h2><p class="muted">Záloha obsahuje všetky projekty, odoslané verzie, e-mailové šablóny a administrátorské účty. SMTP heslá v nej nie sú, pretože sa ukladajú v prostredí servera.</p><a class="button-link" href="backup.php?action=download">Stiahnuť kompletnú zálohu</a></section>
